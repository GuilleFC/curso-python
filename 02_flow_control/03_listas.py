###
# 03 - Listas
# Secuencias mutablas de elementos. Pueden contener elementos de diferentes tipos
###
...
print(lista2[-1]) # plátanos (porque -1 es el último registro de la lista, -2 es el penúltimo y así sucesivamente)
...
print(lista1[3:]) # [4,5]
print(lista1[:]) # [1,2,3,4,5] -> Es como hacer una copia de la lista original
